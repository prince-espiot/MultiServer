...
QT_MOC_LITERAL(9, 13), // "errorOccurred"
QT_MOC_LITERAL(23, 0), // ""
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::errorOccurred)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::errorOccurred(QTcpSocket::SocketError _t1)
{
